 ...
 * in IEC 61850-based smart grids. Designed to interoperate with {@link java.br.ufu.facom.ereno.general.ProtectionIED}, {@link java.br.ufu.facom.ereno.messages.Goose}, and {@link java.br.ufu.facom.ereno.messages.Sv} messages.
 *
 * @see java.br.ufu.facom.ereno.general.ProtectionIED
 * @see java.br.ufu.facom.ereno.messages.Goose
 * @see java.br.ufu.facom.ereno.messages.Sv
 */
    ...
    public static void writeGooseMessagesToFile(ArrayList<Goose> gooseMessages, boolean printHeader) throws IOException {
        ...
        for (Goose gm : gooseMessages) {
            if (prev != null) {
                ...
                if (Debug.printSignatures) {
                    System.out.println(gooseString);
                }
                write(gooseString);
                if (Debug.gooseMessages) {
